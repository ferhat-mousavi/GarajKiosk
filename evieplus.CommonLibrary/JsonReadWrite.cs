...
namespace evieplus.CommonLibrary
{
    public class JsonReadWrite<T>
    {
        ...
        {
            prop_strJsonFileName = "Settings.Jsn";
        }
        ...
        public bool bWrite(T prm_objTemplate)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(strJsonData))
                {
                    try
                    {
                        using (StreamWriter xStreamWriter = new StreamWriter("Settings.Jsn", false))
                        {
        ...
        public bool bRead(ref T prm_ref_objTemplate)
        {
            ...
            try
            {
                ...
                try
                {
                    using (StreamReader xStreamReader = new StreamReader("Settings.Jsn", true))
                    {
